...
public class RSocketWishlistController {
	...
	// java -jar rsc-0.9.1.jar --debug --request --data "{\"wishListId\":\"123\",
	// \"name\":\"birthday wishlist\", \"userEmail\":\"dummy@s.afeka.ac.il\",
	// \"createdTimestamp\":\"2021-12-09T13:38:23.104+0000\"}" --route
	// wishList-create-req-resp tcp://localhost:7000
	...
	// java -jar rsc-0.9.1.jar --debug --fnf --data
	// "{\"wishListId\":\"61b77330b17283089c8ddf29\", \"productId\":\"p42\"}"
	// --route addProd-fire-and-forget tcp://localhost:7000
	...
	// java -jar rsc-0.9.1.jar --debug --stream --data "{\"sortBy\":[\"userEmail\",
	// \"wishListId\"], \"order\":\"ASC\"}" --route getLists-stream
	// tcp://localhost:7000
	...
	// java -jar rsc-0.9.1.jar --debug --stream --data
	// "{\"wishListId\":\"61b77330b17283089c8ddf29\"}" --route
	// getProductsByList-stream tcp://localhost:7000
	...
	// java -jar rsc-0.9.1.jar --debug --stream --data "{\"userEmail\":\"bla\"}"
	// --route getLists-byEmail-stream tcp://localhost:7000
	@MessageMapping("getLists-byEmail-stream")
	public Flux<WishListBoundary> getListsByEmail(UserBoundary userBoundary) {
		this.logger.debug("Received getWishlists stream: " + userBoundary);
	...
	// java -jar rsc-0.9.1.jar --debug --fnf --data "{}" --route
	// cleanup-fire-and-forget tcp://localhost:7000
